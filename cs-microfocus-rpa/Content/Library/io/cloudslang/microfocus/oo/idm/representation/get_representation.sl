########################################################################################################################
#!!
#! @description: Receives the representation (group rule) json.
#!
...
#!
#! @output repre_json: JSON document describing the representation details
#!!#
########################################################################################################################
...
flow:
  ...
  workflow:
    - get_representations:
        do:
          io.cloudslang.microfocus.oo.idm.representation.get_representations:
            - token: '${token}'
            - org_id: '${org_id}'
            - group_id: '${group_id}'
        publish:
